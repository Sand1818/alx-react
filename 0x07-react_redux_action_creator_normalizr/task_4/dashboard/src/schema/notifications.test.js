...
describe('normalize data', () => {
  it('should verify that your normalized data has a correct result array.', () => {
    const result = [
  ...
  it('should verify that your normalized data has a correct users entity', () => {
    const user = {
      age: 25,
  ...
  it('should verify that your normalized data has a correct messages entity', () => {
    const message = {
    ...
    expect(normalizedData.entities.messages['efb6c485-00f7-4fdf-97cc-5e12d14d6c41'])
      .toEqual(message);
  });

  it('should verify that your normalized data has a correct notifications entity', () => {
    const notification = {
    ...
    expect(normalizedData.entities.notifications['5debd7642e815cd350407777'])
